/* VuforiaNative - AR4AndroidApplication Example
 *
 * Example Chapter 5
...
class AR4AndroidApplication_UpdateCallback : public QCAR::UpdateCallback
{   
...
AR4AndroidApplication_UpdateCallback updateCallback;



JNIEXPORT void JNICALL
Java_com_ar4android_AR4AndroidActivity_setActivityPortraitMode(JNIEnv *, jobject, jboolean isPortrait)
{
...
JNIEXPORT void JNICALL
Java_com_ar4android_AR4AndroidActivity_switchDatasetAsap(JNIEnv *, jobject)
{
...
Java_com_ar4android_AR4AndroidActivity_initTracker(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_AR4AndroidActivity_initTracker");
...
JNIEXPORT void JNICALL
Java_com_ar4android_AR4AndroidActivity_deinitTracker(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_AR4AndroidActivity_deinitTracker");
...
JNIEXPORT int JNICALL
Java_com_ar4android_AR4AndroidActivity_loadTrackerData(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_AR4AndroidActivity_loadTrackerData");
    ...
    // Load the data sets:
    if (!dataSetStonesAndChips->load("AR4AndroidApplication.xml", QCAR::DataSet::STORAGE_APPRESOURCE))
    {
...
JNIEXPORT int JNICALL
Java_com_ar4android_AR4AndroidActivity_destroyTrackerData(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_AR4AndroidActivity_destroyTrackerData");
...
JNIEXPORT void JNICALL
Java_com_ar4android_AR4AndroidActivity_onQCARInitializedNative(JNIEnv *, jobject)
{
...
JNIEXPORT void JNICALL
Java_com_ar4android_AR4AndroidApplication_updateTracking(JNIEnv *env, jobject obj)
{
    //LOG("Java_com_ar4android_AR4AndroidActivity_GLRenderer_renderFrame");
...
JNIEXPORT void JNICALL
Java_com_ar4android_AR4AndroidActivity_initApplicationNative(
                            JNIEnv* env, jobject obj, jint width, jint height)
{
    LOG("Java_com_ar4android_AR4AndroidActivity_initApplicationNative");
    ...
    LOG("Java_com_ar4android_AR4AndroidActivity_initApplicationNative finished");
}


JNIEXPORT void JNICALL
Java_com_ar4android_AR4AndroidActivity_deinitApplicationNative(
                                                        JNIEnv* env, jobject obj)
{
    LOG("Java_com_ar4android_AR4AndroidActivity_deinitApplicationNative");
...
JNIEXPORT void JNICALL
Java_com_ar4android_AR4AndroidActivity_startCamera(JNIEnv *,
                                                                         jobject)
{
    LOG("Java_com_ar4android_AR4AndroidActivity_startCamera");
...
JNIEXPORT void JNICALL
Java_com_ar4android_AR4AndroidActivity_stopCamera(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_AR4AndroidActivity_stopCamera");
...
JNIEXPORT void JNICALL
Java_com_ar4android_AR4AndroidActivity_setProjectionMatrix(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_AR4AndroidActivity_setProjectionMatrix");
...
Java_com_ar4android_AR4AndroidActivity_activateFlash(JNIEnv*, jobject, jboolean flash)
{
    return QCAR::CameraDevice::getInstance().setFlashTorchMode((flash==JNI_TRUE)) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_com_ar4android_AR4AndroidActivity_autofocus(JNIEnv*, jobject)
{
...
JNIEXPORT jboolean JNICALL
Java_com_ar4android_AR4AndroidActivity_setFocusMode(JNIEnv*, jobject, jint mode)
{
    int qcarFocusMode;
...
JNIEXPORT void JNICALL
Java_com_ar4android_AR4AndroidApplication_initTracking(
                        JNIEnv* env, jobject obj, jint width, jint height)
{
    LOG("Java_com_ar4android_AR4AndroidApplication_initTracking");
